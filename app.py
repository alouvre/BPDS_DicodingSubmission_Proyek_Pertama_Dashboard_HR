...
scaler = joblib.load('model_random_forest.pkl')
...
daily_rate = st.number_input('Daily Rate', min_value=0, max_value=2000, value=800)
...
hourly_rate = st.number_input('Hourly Rate', min_value=0, max_value=300, value=60)
monthly_income = st.number_input('Monthly Income', min_value=1000, max_value=20000, value=5000)
monthly_rate = st.number_input('Monthly Rate', min_value=0, max_value=30000, value=10000)
